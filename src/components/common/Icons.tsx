...
export const IconLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="72" height="32" viewBox="0 0 72 32" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const IconX: React.FC<IconProps> = ({ size = 64, fillColor = '#31C3BD', className, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 64 64"
...
export const IconO: React.FC<IconProps> = ({ size = 64, fillColor = '#F2B137', className, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 64 64"
...
export const IconXOutline: React.FC<IconProps> = ({ size = 64, className, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 64 64"
...
export const IconOOutline: React.FC<IconProps> = ({ size = 66, className, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 66 66"
...
export const IconRestart: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg
    width="20"
    height="20"
    viewBox="0 0 20 20"
